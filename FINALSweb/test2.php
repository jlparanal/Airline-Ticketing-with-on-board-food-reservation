...
<body>
	...
	<div class="container" id="homepage">
		...
		<div class="btn-group btn-group-justified">			
			<div class="btn-group">
			<button id="button1" type="button" href="#Fish" class="btn btn-primary">Fish</button>
			</div>
			<div class="btn-group">
			<button id="button2" type="button" href="#Pork" class="btn btn-primary">Pork</button>
			</div>
			<div class="btn-group">
			<button id="button3" type="button" href="#Beef" class="btn btn-primary">Beef</button>
			</div>
		</div>
		<hr />
	<div id="Fish">
