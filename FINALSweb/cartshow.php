...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1><center>Flight cart</center></h1>
...
$rowcount = mysqli_num_rows($result);
    ...
    if($rowcount == 0){
        echo "<div class='alert alert-info'><strong>Nothing in the Flight cart.</strong></div>";
    }
    else{
   ...
   echo " <form action='pay.php' method='post'>";
    echo "<div class='row'>
			  ...
			  <div class='col-sm-4'><p class='lead'>Total: <span id='total'>P".$total."</span></p></div>
